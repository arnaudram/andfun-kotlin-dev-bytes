...
class DevByteApplication : Application() {
    ...
    // Create CoroutineScope variable applicationScope, using Dispatchers.Default.
    val applicationScope = CoroutineScope(Dispatchers.Default)
    // Create a delayedInit() function that calls setupRecurringWork() in
    // the coroutine you defined above.

    //  Create a setupRecurringWork() function and use a Builder to define a
    // repeatingRequest variable to handle scheduling work.

    //  In setupRecurringWork(), get an instance of WorkManager and
